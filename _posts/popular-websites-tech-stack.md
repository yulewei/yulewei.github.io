...
- 1995.04，[Apache HTTP Server](https://en.wikipedia.org/wiki/Apache_HTTP_Server) 首次对外开源发布，版本为 0.6.2，源码采用 [Apache 协议](https://en.wikipedia.org/wiki/Apache_License)。
